 ...
 * Run: npm run seed
 * 
 * Creates sample projects and blog posts
 * Admin user is now managed via Supabase Auth (create in Supabase dashboard)
 */
...
async function main() {
  ...
  // Note: Admin user is created in Supabase Auth dashboard, not in the database.
  console.log('ℹ  Admin user should be created in Supabase Auth dashboard.\n');
...
X-RateLimit-Reset: 1640000000</code></pre>
  ...
  console.log('  Password: Nisschay@2026!');
}
